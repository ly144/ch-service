...
//    }
    ...
    public static int ffmpeg(String filename) {
        getPath(filename);
    ...
    private static void getPath(String filename) {
        // 先获取当前项目路径，在获得源文件、目标文件、转换器的路径
//        File diretory = new File("");
//        try {
//            String currPath = diretory.getAbsolutePath();
            inputPath = "F:\\input\\" + filename;
            outputPath = "F:\\output\\";
            ffmpegPath = "E:\\IntelliJ\\ch-app\\service\\src\\main\\java\\com\\ch\\ffmpeg\\";
