...
public interface CommunityMapper {
    ...
    @Insert("INSERT into answer(userId,communityId,content,time) VALUES (#{answer.userId},#{answer.communityId},#{answer.content},#{answer.time})")
    int setApeAnswer(@Param("answer") Answer answer);
